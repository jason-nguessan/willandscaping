...
<template>
	...
	<nav id="nav" class="lg:hidden  lg:container lg:mx-auto  ">
		...
		<div
			class=" z-10 max-w-screen-lg xl:max-w-screen-xl  flex justify-end items-center my-6"
		>
			...
			<AppHeaderLinks  class=" absolute z-50 top-11 w-full max-w-xs bg-primary-night-dark rounded-lg shadow-lg p-6" :showModal="false" :isOpen="isOpen" />
		</Transition>
